...
os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"
...
with gr.Blocks(css=css,theme=gr.themes.Monochrome()) as demo:
    ...
    with gr.Column():
        gr.Markdown('ChatPDF')
        pdf_doc = gr.File(label="C:\\Users\\dhanu\\Dropbox\\Desktop\\Mess .pdf",file_types=['.pdf'],type='filepath')
        with gr.Row():
